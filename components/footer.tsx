      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-muted-foreground text-sm max-w-xs">
              Handcrafted artworks created by artisans supported by B-type employment services on Ishigaki Island, Okinawa, Japan.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="/products?category=pottery" className="text-muted-foreground hover:text-primary text-sm">
                  Pottery
                </Link>
              </li>
              <li>
                <Link href="/products?category=textiles" className="text-muted-foreground hover:text-primary text-sm">
                  Textiles
                </Link>
              </li>
              <li>
                <Link href="/products?category=accessories" className="text-muted-foreground hover:text-primary text-sm">
                  Accessories
                </Link>
              </li>
              <li>
                <Link href="/products?category=art" className="text-muted-foreground hover:text-primary text-sm">
                  Paintings & Art
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link href="/creators" className="text-muted-foreground hover:text-primary text-sm">
                  Meet the Creators
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 border-t border-border pt-8">
          <p className="text-sm text-muted-foreground text-center">
            &copy; {new Date().getFullYear()} Ishigaki Artisans. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
